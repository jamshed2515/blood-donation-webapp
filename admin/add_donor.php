...
<body style="color:black">
  ...
  <script>
    document.forms['donor'].onsubmit = function () {
      let name = document.forms["donor"]["fullname"].value.trim();
      let mobile = document.forms["donor"]["mobileno"].value.trim();
      let age = document.forms["donor"]["age"].value.trim();
      ...
      if (!ageRegex.test(age) || age < 18 || age > 65) {
